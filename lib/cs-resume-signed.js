...
(function( root, factory ) { 
  if( typeof exports === 'object' ) {
    module.exports = factory(window.XMLHttpRequest || require('xmlhttprequest').XMLHttpRequest, require('spark-md5'), require('q'), window.FileReader || require('nodefilereader'), window.Blob || require('node-blob'), window.DOMParser || require('xmldom').DOMParser)
  }
