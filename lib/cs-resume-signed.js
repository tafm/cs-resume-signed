...
(function( root, factory ) { 
  if( typeof exports === 'object' ) {
    ...
    root.cloudStorageSignedResumer = factory( XMLHttpRequest, SparkMD5B, Q, FileReader, Blob, DOMParser)
  }
})(window || this, function(XMLHttpRequest, SparkMD5C, Q, FileReader, Blob, DOMParser) {
  ...
  function calculateMD5Hash(file, bufferSize) {
    ...
    var hashAlgorithm = new SparkMD5D();
